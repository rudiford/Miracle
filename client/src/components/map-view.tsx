          ...
          return (
            ...
            >
              <div className="relative">
                <ChristianCross className="text-faith-gold hover:scale-125 transition-transform drop-shadow-lg" size={36} />
      ...
      {postsWithLocation.length === 0 && (
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center bg-white/90 p-6 rounded-lg shadow-lg">
            <ChristianCross className="text-faith-blue mb-4 mx-auto" size={80} />
